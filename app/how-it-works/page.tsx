...
const STEPS = [
  {
    ...
    desc: 'Begin by creating your secure Smartvest account. Our streamlined onboarding process is designed to provide fast, secure access while maintaining the highest standards of client protection.',
  },
  {
    number: '02',
    icon: ShieldCheck,
  ...
  },
  {
    ...
    desc: "Following account funding and portfolio activation, Smartvest's proprietary artificial intelligence continuously processes market information, monitors portfolio activity, and supports investment decision-making.",
  },
  {
    number: '05',
    icon: LineChart,
  ...
  },
  {
    ...
    desc:  'Smartvest is committed to delivering an exceptional client experience through continuous platform innovation, responsive client support, and secure digital infrastructure.',
  },
];
      ...
      <div className="relative z-10 px-4 py-12 sm:py-16">
        ...
        <div className="max-w-3xl mx-auto text-center mb-14 sm:mb-20">
          ...
          <p className="text-gray-300 text-sm sm:text-base lg:text-lg leading-relaxed">
            At Smartvest, we have developed an investment platform that combines advanced artificial intelligence, secure digital infrastructure, and a seamless client experience — from onboarding to ongoing portfolio management, every stage is designed to deliver efficiency, transparency, and confidence.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto mb-16 sm:mb-24">
          <div className="relative">
            ...
            <div className="hidden sm:block absolute left-8 top-8 bottom-8 w-px bg-gradient-to-b from-blue-500/50 via-blue-500/20 to-transparent"></div>
              ...
              {STEPS.map((step, idx) => (
                <div key={idx} className="relative flex flex-col sm:flex-row gap-4 sm:gap-6">
                  <div className="flex-shrink-0 relative z-10 flex sm:flex-col items-center gap-3 sm:gap-2">
                    <div className="w-16 h-16 bg-gradient-to-br from-blue-400 to-blue-600 rounded-2xl flex items-center justify-center shadow-lg shadow-blue-500/40">
                      <step.icon className="w-7 h-7 text-black" />
                    </div>
                    <span className="text-blue-400 font-bold text-xs tracking-widest sm:hidden">{step.number}</span>
                  </div>

                  <div className="flex-1 bg-gray-900/60 backdrop-blur-lg rounded-2xl border border-blue-500/20 p-5 sm:p-6">
                    <div className="flex items-center gap-3 mb-2">
                      <span className="hidden sm:inline text-blue-400 font-bold text-xs tracking-widest">{step.number}</span>
        ...
        <div className="max-w-5xl mx-auto mb-16 sm:mb-24">
          <div className="text-center mb-8 sm:mb-10">
            <Sparkles className="w-10 h-10 sm:w-12 sm:h-12 text-blue-400 mx-auto mb-3" />
            <h3 className="text-2xl sm:text-3xl font-bold text-white mb-2">The Smartvest Advantage</h3>
            <p className="text-blue-300 text-sm sm:text-base font-medium">Where Innovation Meets Institutional Excellence</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
            {ADVANTAGES.map((item, idx) => (
              <div key={idx} className="flex items-center gap-3 bg-gray-900/50 backdrop-blur-lg rounded-xl border border-blue-500/20 px-4 sm:px-5 py-3 sm:py-4">
        ...
        <div className="max-w-3xl mx-auto mb-16 sm:mb-20">
          <div className="bg-gray-900/60 backdrop-blur-lg rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-blue-500/20 shadow-2xl shadow-blue-500/10 text-center">
            ...
            <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
              At Smartvest, we believe that exceptional investment platforms are built on more than technology alone. They are built on trust, disciplined innovation, operational excellence, and a commitment to delivering an outstanding client experience.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-2xl mx-auto text-center">
          <Link href="/sign-up">
            <button className="group bg-gradient-to-r from-blue-400 to-blue-600 hover:from-blue-500 hover:to-blue-700 text-black font-bold py-4 px-8 rounded-full transition-all duration-300 shadow-lg shadow-blue-500/50 hover:shadow-xl hover:shadow-blue-500/70 transform hover:scale-105 text-base sm:text-lg inline-flex items-center gap-2">
              Get Started Now
