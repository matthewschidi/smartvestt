      ...
      <div className="relative z-10 px-4 py-12 sm:py-16">
        ...
        <div className="max-w-4xl mx-auto mb-16 sm:mb-20">
          <div className="bg-gray-900/60 backdrop-blur-lg rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-blue-500/20 shadow-2xl shadow-blue-500/10">
            ...
            <p className="text-gray-300 text-sm sm:text-base leading-relaxed mb-4">
              SmartVest was founded with a vision to redefine the way investors interact with financial technology. As global markets continue to evolve through artificial intelligence, automation, and digital transformation, we recognized the opportunity to create a platform that combines innovation with simplicity.
            </p>
        ...
        <div className="max-w-5xl mx-auto mb-16 sm:mb-20">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            <div className="bg-gray-900/50 backdrop-blur-lg rounded-2xl border border-blue-500/20 p-6 sm:p-8">
              ...
              <p className="text-blue-300 text-sm font-medium mb-3">Empowering Intelligent Financial Decisions</p>
            ...
            <div className="bg-gray-900/50 backdrop-blur-lg rounded-2xl border border-blue-500/20 p-6 sm:p-8">
              ...
              <p className="text-blue-300 text-sm font-medium mb-3">Leading the Next Generation of Investment Technology</p>
              <p className="text-gray-400 text-sm leading-relaxed">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 sm:gap-5">
            {CORE_VALUES.map((v, idx) => (
              <div key={idx} className="text-center bg-gray-900/50 backdrop-blur-lg rounded-2xl border border-amber-500/20 p-5 sm:p-6">
                <div className="w-11 h-11 sm:w-12 sm:h-12 bg-gradient-to-br from-blue-400 to-blue-600 rounded-xl flex items-center justify-center mx-auto mb-3">
        ...
        <div className="max-w-4xl mx-auto mb-16 sm:mb-20">
          <div className="bg-gray-900/60 backdrop-blur-lg rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-blue-500/20 shadow-2xl shadow-blue-500/10">
            <div className="text-center mb-6 sm:mb-8">
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-white mb-2">Why SmartVest</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {CAPABILITIES.map((item, idx) => (
                <div key={idx} className="flex items-center gap-3 bg-black/30 rounded-lg px-4 py-3 border border-blue-500/10">
        ...
        <div className="max-w-5xl mx-auto mb-16 sm:mb-20">
          <div className="text-center mb-8 sm:mb-10">
            <Cpu className="w-10 h-10 sm:w-12 sm:h-12 text-blue-400 mx-auto mb-3" />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {TECH_FOCUS.map((item, idx) => (
              <div key={idx} className="text-center bg-gray-900/50 backdrop-blur-lg rounded-xl border border-blue-500/20 p-4 sm:p-5">
                <span className="text-blue-300 text-sm sm:text-base font-medium">{item}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto mb-16 sm:mb-20">
          <div className="bg-gray-900/60 backdrop-blur-lg rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-blue-500/20 shadow-2xl shadow-blue-500/10">
            <div className="text-center mb-6 sm:mb-8">
              <ShieldCheck className="w-10 h-10 sm:w-12 sm:h-12 text-blue-400 mx-auto mb-3" />
              <h3 className="text-xl sm:text-2xl font-bold text-white mb-2">Security & Privacy</h3>
              <p className="text-blue-300 text-sm sm:text-base font-medium">Protecting What Matters Most</p>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        <div className="max-w-3xl mx-auto mb-16 sm:mb-20 text-center">
          <Globe className="w-10 h-10 sm:w-12 sm:h-12 text-blue-400 mx-auto mb-3" />
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-blue-300 font-semibold text-sm sm:text-base mb-3">
          ...
          <p className="text-gray-400 text-xs sm:text-sm leading-relaxed italic">
            At SmartVest AI, we are committed to building more than a platform—we are building lasting trust through intelligent technology, responsible innovation, and an unwavering dedication to excellence.
          </p>
        </div>
      </div>
    </div>
