      ...
      <div className="relative z-10 px-4 py-12 sm:py-16">
        ...
        <div className="max-w-3xl mx-auto text-center mb-14 sm:mb-20">
          ...
          <p className="text-gray-300 text-sm sm:text-base lg:text-lg leading-relaxed">
            At Smartvest , security is not simply a feature—it is the foundation upon which our platform is built. Every aspect of our technology, operations, and client experience is designed to protect the integrity of our platform and safeguard the information and assets entrusted to us.
          </p>
        </div>
        ...
        <div className="max-w-3xl mx-auto mb-16 sm:mb-20">
          <div className="bg-gray-900/60 backdrop-blur-lg rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-blue-500/20 shadow-2xl shadow-blue-500/10 text-center">
            ...
            <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
              Security is embedded throughout the Smartvest  ecosystem—from account authentication and data protection to infrastructure resilience, operational oversight, and continuous platform monitoring. Because trust is earned, not assumed.
            </p>
          </div>
        </div>
          ...
          <div className="bg-gray-900/60 backdrop-blur-lg rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-blue-500/20 shadow-2xl shadow-blue-500/10">
            <div className="text-center mb-6 sm:mb-8">
              ...
              <p className="text-gray-300 text-sm sm:text-base max-w-xl mx-auto">
                Every component of Smartvest  has been developed with security as a guiding principle—not as an afterthought.
              </p>
            </div>
        ...
        <div className="max-w-3xl mx-auto mb-16 sm:mb-20 text-center">
          <TrendingUp className="w-10 h-10 sm:w-12 sm:h-12 text-blue-400 mx-auto mb-3" />
          <h3 className="text-xl sm:text-2xl font-bold text-white mb-4">Risk Management</h3>
          <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
            Effective risk management is essential to maintaining a trusted investment platform. Smartvest  follows a disciplined approach focused on identifying, evaluating, and responding to operational and technology-related risks while continuously strengthening internal controls and governance practices.
          </p>
        </div>
        ...
        <div className="max-w-6xl mx-auto mb-16 sm:mb-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 sm:gap-5">
            {PRINCIPLES.map((p, idx) => (
              <div key={idx} className="text-center bg-gray-900/50 backdrop-blur-lg rounded-2xl border border-blue-500/20 p-5">
                <h4 className="text-blue-300 font-semibold text-sm sm:text-base mb-2">{p.title}</h4>
        ...
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-gray-400 text-xs sm:text-sm leading-relaxed italic">
            At Smartvest , we understand that security is more than technology—it is a responsibility. Our commitment is to uphold the highest standards of operational integrity, safeguard the trust our clients place in us, and continuously strengthen the platform through disciplined innovation, responsible governance, and a relentless focus on protecting the client experience.
          </p>
        </div>
      </div>
    </div>
