      ...
      <div className="relative z-10 px-4 py-12 sm:py-16">
        ...
        <div className="max-w-3xl mx-auto text-center mb-14 sm:mb-16">
          ...
          <p className="text-gray-300 text-sm sm:text-base lg:text-lg leading-relaxed">
            Our Client Services team is available to assist with account inquiries, technical support, and general platform information. Send us a message and we will respond as quickly as possible.
          </p>
        </div>
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-10">
          ...
          <div className="lg:col-span-2 space-y-4 sm:space-y-6">
            <div className="bg-gray-900/60 backdrop-blur-lg rounded-2xl border border-blue-500/20 p-5 sm:p-6">
          ...
          <div className="lg:col-span-3">
            <form
              ...
              className="bg-gray-900/60 backdrop-blur-lg rounded-2xl sm:rounded-3xl border border-blue-500/20 shadow-2xl shadow-blue-500/10 p-6 sm:p-8 space-y-4 sm:space-y-5"
            >
              <div>
              ...
              <button
                type="submit"
                className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-blue-400 to-blue-600 hover:from-blue-500 hover:to-blue-700 text-black font-semibold py-3 px-6 rounded-xl transition-all duration-300 shadow-lg shadow-blue-500/50 hover:shadow-xl hover:shadow-blue-500/70 transform hover:scale-105"
              >
